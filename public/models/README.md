...
**Landmark embedding upgrade (v0.87+):** Clear server training data, re-record teacher voice seed, collect new judgments, then `npm run publish:model`. Models trained on 13-D embeddings (manifest v7 and below) are incompatible.
