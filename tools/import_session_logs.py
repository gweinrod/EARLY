        ...
        rows.append(
            {
                ...
                "dsp_guess_word": a.get("dspGuessWord"),
                "dsp_pass": a.get("dspPass"),
                "dsp_guess_wrong": a.get("dspGuessWrong"),
                "teacher_heard": a.get("teacherHeard"),
                "teacher_heard_key": a.get("teacherHeardKey"),
                "target_key": a.get("targetKey"),
                "curriculum_stage": a.get("curriculumStage"),
